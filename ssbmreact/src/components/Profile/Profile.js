            ...
            <div className={styles.flexbox}>
                ...
                <div className={styles.flexTwoThird}>
                    <div className={styles.box}>
                        ...
                        <div className={styles.content}>
                            <p className={styles.p}>lorem lorem lorem dsflksdfjlalsdf lorem lorem lorem
                                lorem lorem lorem dsflksdfjlalsdf lorem lorem lorem lorem lorem lorem
                                dsflksdfjlalsdf lorem lorem lorem lorem lorem lorem dsflksdfjlalsdf lorem lorem
                                lorem lorem lorem lorem dsflksdfjlalsdf lorem lorem loremlorem lorem lorem
                                dsflksdfjlalsdf lorem lorem lorem</p>
                        </div>
                    </div>
